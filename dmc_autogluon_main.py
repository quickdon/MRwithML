...
if __name__ == "__main__":
    npz_files = ['VQM24/DMC_rdkit_fingerprints.npz', 'VQM24/DMC_pubchem_fingerprints.npz', 'VQM24/DMC_atompair_fingerprints.npz', 
                 'VQM24/DMC_torsion_fingerprints.npz', 'VQM24/DMC_pattern_fingerprints.npz', 'VQM24/DMC_layered_fingerprints.npz',
                 'VQM24/DMC_maccs_fingerprints.npz', 'VQM24/DMC_ecfp_fingerprints.npz', 'VQM24/DMC_fcfp_fingerprints.npz']
