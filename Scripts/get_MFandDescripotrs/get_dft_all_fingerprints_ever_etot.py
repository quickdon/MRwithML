...
# 保存到新的npz文件中
np.savez('VQM24/DFT_maccs_fingerprints_ever_etot.npz', fingerprints=maccs_fingerprints, smiles=smiles_list, Etot=Etot, average_Etot=average_Etot, total_atoms=total_atoms)
np.savez('VQM24/DFT_ecfp_fingerprints_ever_etot.npz', fingerprints=ecfp_fingerprints, smiles=smiles_list, Etot=Etot, average_Etot=average_Etot, total_atoms=total_atoms)
np.savez('VQM24/DFT_fcfp_fingerprints_ever_etot.npz', fingerprints=fcfp_fingerprints, smiles=smiles_list, Etot=Etot, average_Etot=average_Etot, total_atoms=total_atoms)
np.savez('VQM24/DFT_rdkit_fingerprints_ever_etot.npz', fingerprints=rdkit_fingerprints, smiles=smiles_list, Etot=Etot, average_Etot=average_Etot, total_atoms=total_atoms)
np.savez('VQM24/DFT_atompair_fingerprints_ever_etot.npz', fingerprints=atompair_fingerprints, smiles=smiles_list, Etot=Etot, average_Etot=average_Etot, total_atoms=total_atoms)
np.savez('VQM24/DFT_torsion_fingerprints_ever_etot.npz', fingerprints=torsion_fingerprints, smiles=smiles_list, Etot=Etot, average_Etot=average_Etot, total_atoms=total_atoms)
np.savez('VQM24/DFT_pattern_fingerprints_ever_etot.npz', fingerprints=pattern_fingerprints, smiles=smiles_list, Etot=Etot, average_Etot=average_Etot, total_atoms=total_atoms)
np.savez('VQM24/DFT_layered_fingerprints_ever_etot.npz', fingerprints=layered_fingerprints, smiles=smiles_list, Etot=Etot, average_Etot=average_Etot, total_atoms=total_atoms)
