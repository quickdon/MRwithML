...
# 过滤掉无法处理的分子
valid_indices = [i for i in range(len(maccs_fingerprints)) if maccs_fingerprints[i] is not None and ecfp_fingerprints[i] is not None and fcfp_fingerprints[i] is not None 
                 and rdkit_fingerprints[i] is not None and atompair_fingerprints[i] is not None and torsion_fingerprints[i] is not None and pattern_fingerprints[i] is not None]
...
# 保存到新的npz文件中
np.savez('VQM24/DMC_maccs_fingerprints.npz', fingerprints=maccs_fingerprints, smiles=smiles_list, Etot=Etot)
np.savez('VQM24/DMC_ecfp_fingerprints.npz', fingerprints=ecfp_fingerprints, smiles=smiles_list, Etot=Etot)
np.savez('VQM24/DMC_fcfp_fingerprints.npz', fingerprints=fcfp_fingerprints, smiles=smiles_list, Etot=Etot)
np.savez('VQM24/DMC_rdkit_fingerprints.npz', fingerprints=rdkit_fingerprints, smiles=smiles_list, Etot=Etot)
np.savez('VQM24/DMC_atompair_fingerprints.npz', fingerprints=atompair_fingerprints, smiles=smiles_list, Etot=Etot)
np.savez('VQM24/DMC_torsion_fingerprints.npz', fingerprints=torsion_fingerprints, smiles=smiles_list, Etot=Etot)
np.savez('VQM24/DMC_pattern_fingerprints.npz', fingerprints=pattern_fingerprints, smiles=smiles_list, Etot=Etot)
np.savez('VQM24/DMC_layered_fingerprints.npz', fingerprints=layered_fingerprints, smiles=smiles_list, Etot=Etot)
