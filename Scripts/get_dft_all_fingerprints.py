...
Exc = Exc[valid_indices]
Eee = Eee[valid_indices]
Cp = Cp[valid_indices]
Eatom = Eatom[valid_indices]
...
# 保存到新的npz文件中
np.savez('VQM24/DFT_maccs_fingerprints.npz', fingerprints=maccs_fingerprints, smiles=smiles_list, Etot=Etot, Exc=Exc, Eee=Eee, Cp=Cp, Eatom=Eatom)
np.savez('VQM24/DFT_ecfp_fingerprints.npz', fingerprints=ecfp_fingerprints, smiles=smiles_list, Etot=Etot, Exc=Exc, Eee=Eee, Cp=Cp, Eatom=Eatom)
np.savez('VQM24/DFT_fcfp_fingerprints.npz', fingerprints=fcfp_fingerprints, smiles=smiles_list, Etot=Etot, Exc=Exc, Eee=Eee, Cp=Cp, Eatom=Eatom)
np.savez('VQM24/DFT_rdkit_fingerprints.npz', fingerprints=rdkit_fingerprints, smiles=smiles_list, Etot=Etot, Exc=Exc, Eee=Eee, Cp=Cp, Eatom=Eatom)
np.savez('VQM24/DFT_atompair_fingerprints.npz', fingerprints=atompair_fingerprints, smiles=smiles_list, Etot=Etot, Exc=Exc, Eee=Eee, Cp=Cp, Eatom=Eatom)
np.savez('VQM24/DFT_torsion_fingerprints.npz', fingerprints=torsion_fingerprints, smiles=smiles_list, Etot=Etot, Exc=Exc, Eee=Eee, Cp=Cp, Eatom=Eatom)
np.savez('VQM24/DFT_pattern_fingerprints.npz', fingerprints=pattern_fingerprints, smiles=smiles_list, Etot=Etot, Exc=Exc, Eee=Eee, Cp=Cp, Eatom=Eatom)
np.savez('VQM24/DFT_layered_fingerprints.npz', fingerprints=layered_fingerprints, smiles=smiles_list, Etot=Etot, Exc=Exc, Eee=Eee, Cp=Cp, Eatom=Eatom)
