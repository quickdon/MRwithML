...
def plot_comparison(y_test, y_pred, title='Predicted vs Actual Etot', save_path='path/comparison.png'):
    """
    绘制预测值和真实值的比较图并保存
    """
...
def main(npz_file, model_type='random_forest'):
    ...
    plot_comparison(y_test, y_pred, title=f'Predicted vs Actual Etot ({model_type} with {finger_name})', save_path=f'path/{finger_name}_{model_type}_comparison.png')
...
if __name__ == "__main__":
    ...
    npz_files = ['VQM24/DMC_rdkit_fingerprints.npz', 'VQM24/DMC_pubchem_fingerprints.npz', 'VQM24/DMC_atompair_fingerprints.npz', 
                 'VQM24/DMC_torsion_fingerprints.npz', 'VQM24/DMC_pattern_fingerprints.npz', 'VQM24/DMC_maccs_fingerprints.npz', 
                 'VQM24/DMC_ecfp_fingerprints.npz', 'VQM24/DMC_fcfp_fingerprints.npz', 'VQM24/DMC_layered_fingerprints.npz']
    models = ['random_forest', 'linear_regression', 'ridge', 'svm', 'xgboost', 'adaboost', 'cnn']
